...
<h3 style="margin-left: 30px;margin-top: 30px;">DTU状态数据</h3>
<hr/>
<div style="width: 98%;float: left;margin-left: 20px;margin-right:10px;background-color:  #c2e8ef;">
    ...
    <ul class="nav nav-pills nav-justified">
        ...
        <li role="presentation" class="active"><a href="${basePath }dtuHome/goDataDisplayPage?nodeId=${dtu_sn}">数据显示</a></li>
    </ul>
    <!--导航菜单...-->
</div>
