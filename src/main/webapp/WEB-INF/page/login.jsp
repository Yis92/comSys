    ...
    <div class="login_bar">
        <div class="lg_list">
            <form action = "${basePath}home/doLogin" id="lgForm" method="POST">
                <ul>
                    <li><input type="text" placeholder="用户名" value="dhmaster" class="ipt1" name="user_id" autocomplete="off" id="userName"></li>
                    <li><input type="password" placeholder="密码" value="123456" class="ipt1 ipt_tit" name="pwd" autocomplete="off" id="password"></li>
                    <li><input type="text" placeholder="验证码" value="${sessionScope.code}" class="ipt2" autocomplete="off" id="code" onblur="checkCode();">
