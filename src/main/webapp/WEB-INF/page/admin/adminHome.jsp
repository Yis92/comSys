            ...
            <dl id="menu-picture">
                ...
                <dd>
                    <ul>
                        ...
                        <li><a _href="${basePath }myHome/goComUser.admin?id=${com.unit_no}" data-title="本单位用户维护" href="javascript:void(0)">本单位用户维护</a></li>
                        <%--<li><a _href="${basePath }myHome/goDTUConfig?id=${com.unit_no}" data-title="DTU维护" href="javascript:void(0)">DTU维护</a></li>--%>
                           <c:forEach items="${com.dtu}" var = "dtu" varStatus="sta">
                               <li class="dtu_active"><a _href="${basePath }dtuHome/goDTUPage?nodeId=${dtu.dtu_sn}&type=6" style="color:#080808;" data-title="${dtu.dtu_name}" href="javascript:void(0)">${dtu.dtu_name}</a></li>
                           </c:forEach>
                            <%-- <li><a _href="${basePath}userHome/myInfo" data-title="我的信息" href="javascript:void(0)">我的信息</a></li>--%>
